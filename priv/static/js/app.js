...
function update_buttons() {
  (0, _jquery2.default)(".manage-button").each(function (_, bb) {
    ...
    var manage_id = (0, _jquery2.default)(bb).data('manage');
    if (manage_id == "") {
      (0, _jquery2.default)(bb).text("Manage");
    } else {
      (0, _jquery2.default)(bb).text("UnManage");
    }
  });
}
...
function set_button(user_id, manage_id) {
  (0, _jquery2.default)(".manage-button").each(function (_, bb) {
    if (user_id == (0, _jquery2.default)(bb).data('user-id')) {
      (0, _jquery2.default)(bb).data('manage', manage_id);
    }
  });
  update_buttons();
}
...
// ----------------------------------------------------------------------------------------
function update_buttons() {
  (0, _jquery2.default)(".time-button").each(function (_, bb) {

    var timeblock_id = (0, _jquery2.default)(bb).data('id');
    console.log(timeblock_id);
    if (timeblock_id == "") {
      (0, _jquery2.default)(bb).text("Start time");
    } else {
      (0, _jquery2.default)(bb).text("End time");
    }
  });
}
...
function set_button(user_id, timeblock_id) {
  (0, _jquery2.default)(".time-button").each(function (_, bb) {
    ...
    (0, _jquery2.default)(bb).data('id', timeblock_id);
...
function insert_start_time(user_id, task_id, timeblock_id) {
  var start_time = new Date().toJSON();
  ...
  _jquery2.default.ajax(timeblock_path, {
    method: "POST",
    dataType: "json",
    contentType: "application/json; charset=UTF-8",
    data: text,
...
function insert_end_time(user_id, task_id, timeblock_id) {
  ...
  _jquery2.default.ajax(timeblock_path + "/" + timeblock_id, {
    method: "PUT",
    dataType: "json",
    contentType: "application/json; charset=UTF-8",
    data: text,
    success: function success(resp) {
      set_button(user_id, timeblock_id);
    }
  });
}

function init_task() {
  if (!(0, _jquery2.default)(".time-button")) {
    return;
  }
